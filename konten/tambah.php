            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        btn-info" type="submit"><i class="fas fa-barcode"></i> Cari By Barcode</button></form>
                        </div>
                        <div class="form-group col-sm-3">
                            <button class="btn btn-black btn-success" type="button" data-toggle="modal" data-target="#cariProduk"><i class="fas fa-tags"></i> Cari By Nama</button>
                        </div>
