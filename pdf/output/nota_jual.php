...
$no=0;
        $total_item=0;
        $total_belanja=0;
        $sql2="SELECT detailpenjualan.*,produk.NamaProduk,produk.Barcode FROM detailpenjualan,produk WHERE detailpenjualan.ProdukID=produk.ProdukID AND detailpenjualan.penjualanID AND detailpenjualan.PenjualanID AND detailpenjualan.PenjualanID=$PenjualanID";
